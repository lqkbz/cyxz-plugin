 ...
 * @param {string} customPdfDir - 自定义PDF保存目录（可选）
 * @returns {Promise<Object>} - 返回包含PDF路径列表的对象
 */
async function downloadJmComicAsPDF(albumId, configFile = null, startChapter = 1, endChapter = 5, customPdfDir = null) {
